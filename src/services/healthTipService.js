...
// Fetch health tips from localStorage; fall back to bundled seed data when storage is empty
...
// Persist the provided tips array to localStorage. Callers can decide when to save (e.g. after add/edit).
export const setHealthTips = async (tips) => {
